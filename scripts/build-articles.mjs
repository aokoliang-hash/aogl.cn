...
import { injectAmazonBestsellersElectronics20260629Snapshot } from "./amazon-bestsellers-electronics-20260629-lib.mjs";
    ...
    if (raw.htmlFragments && typeof raw.htmlFragments === "object") {
      for (const lang of LANGS) {
        ...
        if (fs.existsSync(fp)) {
          ...
          body = injectAmazonBestsellersElectronics20260629Snapshot(body, lang);
